...
class CustomDeleteCustomerDialog extends StatelessWidget {
  const CustomDeleteCustomerDialog({
    super.key,
    this.onTap,
  ...
  Widget build(BuildContext context) {
    return CustomDialog(
      ...
      children: [
        Text(LocaleKeys.deleteCustomer, style: context.textTheme.displayLarge),
        gapH(12),
        Text(
          LocaleKeys.deleteCustomerExp,
