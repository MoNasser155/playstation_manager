...
class CustomEditCustomerDialog extends StatelessWidget {
  const CustomEditCustomerDialog({super.key, required this.cubit});

  final CustomerDetailsCubit cubit;
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CustomerDetailsCubit, CustomerDetailsState>(
      bloc: cubit,
      buildWhen: (p, c) {
        return p.customerDetails.customer != c.customerDetails.customer;
      },
