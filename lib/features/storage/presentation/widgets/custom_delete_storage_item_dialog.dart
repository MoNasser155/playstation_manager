...
class CustomDeleteStorageItemDialog extends StatelessWidget {
  const CustomDeleteStorageItemDialog({
    super.key,
    required this.item,
    this.onTap,
  });
  ...
  Widget build(BuildContext context) {
    return CustomDialog(
      ...
      children: [
        Text(
          LocaleKeys.deleteStorageItem,
          style: context.textTheme.displayLarge,
        ),
        gapH(12),
        Text(
          LocaleKeys.deleteStorageItemExp,
