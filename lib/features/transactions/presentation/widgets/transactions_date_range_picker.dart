...
class TransactionsDateRangePicker extends StatelessWidget {
  const TransactionsDateRangePicker({super.key});
          ...
          children: [
            ...
            _DatePickerField(
              ...
              onPick: (picked) {
                ...
                TransactionsCubit.get(
                  context,
                ).onDateRangeChanged(newFrom, picked);
              },
